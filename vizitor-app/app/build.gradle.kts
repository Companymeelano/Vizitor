...
android {
    ...
    defaultConfig {
        ...
        // «نسخهٔ قدیمی‌تر» انجام شود. نسخهٔ ۲٫۱۳٫۶ همان سورس است با بازطراحی کامل
        // صفحهٔ اول، صفحهٔ اتصال، آیکن سه‌بعدی تازه و فونت فارسی وزیرمتن.
        versionCode = 21801
        versionName = "2.13.6-direct"
