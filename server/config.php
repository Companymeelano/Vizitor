...
const DB_HOST     = '37.143.147.19';    // سرور دیتابیس آتیران (ماشین جدا از وب‌سرور — فقط اتصال خواندنی/نوشتنی؛ هیچ تغییری روی آن اعمال نمی‌شود)
const DB_PORT     = 1433;               // پورت استاندارد SQL Server — باید از وب‌سرور به ۳۷٫۱۴۳٫۱۴۷٫۱۹ باز باشد
const DB_NAME     = 'atiran2';          // دیتابیس اصلی آتیران
